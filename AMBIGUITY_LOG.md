...
| **Team Answer**         | The CPU player will select moves based on the most important heuristics to improve its likelihood of winning.                                                                                                     |
| **Status**              | 🔴 Open                                                                                                                                                                                                           |
...
| **Team Answer**         | we will add the rule book as context. This should clarify any remaining ambiguity.                                                                                                                                                                                                       |
| **Status**              | 🔴 Open                                                                                                                                                                                                                                                                                  |
