...
| **Team Answer**         | The CPU player will select moves based on the most important heuristics to improve its likelihood of winning at that given situation.                                                                             |
| **Status**              | 🔴 closed                                                                                                                                                                                                         |
...
| **Team Answer**         | we are going to remove the change request in the next itertion which should solve this ambiguity.                                                                                                                                                                                                                  |
| **Status**              | 🔴 closed                                                                                                                                                                                                                                                                                                          |
...
| **Team Answer**         | State which player won and prompt for replay                                                                                                                                |
| **Status**              | 🔴 closed                                                                                                                                                                   |
...
| **Team Answer**         | We will use the basic scoring scheme, meaning that the player witht eh lowest number of squares wins.                                                                                                                                                                                    |
| **Status**              | 🔴 closed                                                                                                                                                                                                                                                                                |
...
| **Team Answer**         | The assumption is that the the above non-function requirement should be satisfied on standard issued modern laptops.\_                                                                           |
| **Status**              | 🔴 closed                                                                                                                                                                                        |
...
| **Team Answer**         | The idea was to minimize the amount of code that is written, especially if the functions already exist. Only write new lines if there aren't any existing functions with a similar logic already implemented\_                                                           |
| **Status**              | 🔴 closed                                                                                                                                                                                                                                                                |
...
| **Team Answer**         | Use branches when separate features are being implemented. Delete the feature branches upon merging with main.\_                                                 |
| **Status**              | 🔴 Open                                                                                                                                                          |
...
| ------ | --------------------------------------------- | --------- |
| AMB-01 | FR-1.5 — Color continuity definition          | 🔴 closed |
| AMB-02 | FR-3.4 — AI heuristic specification           | 🔴 closed |
| AMB-03 | FR-4.3 — Corner placement in Duo mode         | 🔴 closed |
| AMB-04 | FR-4.4 — Post-termination behavior            | 🔴 closed |
| AMB-05 | FR-4.5 — Scoring formula and bonuses          | 🔴 closed |
| AMB-06 | NFR-1.x — Performance reference environment   | 🔴 closed |
| AMB-07 | M2-AC-2 — Definition of "no code duplication" | 🔴 closed |
| AMB-08 | IR-1.1 — Branching strategy definition        | 🔴 closed |

---

_Generated as part of Guideline 3 application: Proactively Detect and Resolve Ambiguity Through Clarification._
